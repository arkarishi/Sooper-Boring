...
export default function EducationForm({ 
  ...
  const handleFieldChange = (field, value) => {
    onUpdateEducation(education.id, field, value);
  };
      ...
      <div className="flex max-w-full flex-wrap items-end gap-3 sm:gap-4 py-3">
        <label className="flex flex-col min-w-40 flex-1">
          ...
          <input
            ...
            placeholder="e.g., Educational Technology, Computer Science"
          />
        </label>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 py-3">
        <label className="flex flex-col">
          ...
          <CustomDatePicker
            ...
            maxDate={education.current ? new Date() : parseDate(education.end_date) || new Date()}
          />
        </label>
